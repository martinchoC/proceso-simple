...
-- Volcando estructura para tabla gestion_multipyme.accesos_pagina
CREATE TABLE IF NOT EXISTS `accesos_pagina` (
  `pagina_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `usuario_temp` int(11) DEFAULT 0,
  `acceso_rapido` tinyint(4) DEFAULT 0,
...
-- Volcando estructura para tabla gestion_multipyme.conf__botones
CREATE TABLE IF NOT EXISTS `conf__botones` (
  `boton_id` int(11) NOT NULL AUTO_INCREMENT,
  `boton_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `boton_clase` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `boton_icono` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `boton_texto` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `boton_tooltip` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`boton_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.conf__colores
CREATE TABLE IF NOT EXISTS `conf__colores` (
  `color_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre_color` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `color_clase` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bg_clase` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text_clase` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__documento_tipos
CREATE TABLE IF NOT EXISTS `conf__documento_tipos` (
  `documento_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `documento_tipo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__empresas
CREATE TABLE IF NOT EXISTS `conf__empresas` (
  `empresa_id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
  `empresa` char(200) DEFAULT NULL,
  `documento_tipo_id` smallint(6) DEFAULT NULL,
  `documento_numero` double DEFAULT NULL,
  `telefono` char(250) DEFAULT NULL,
  `domicilio` char(250) DEFAULT NULL,
  `localidad_id` smallint(6) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__empresas_modulos
CREATE TABLE IF NOT EXISTS `conf__empresas_modulos` (
  `empresa_modulo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(6) unsigned NOT NULL,
  `modulo_id` tinyint(3) unsigned NOT NULL,
  `tabla_estado_registro_id` tinyint(3) DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__empresas_perfiles
CREATE TABLE IF NOT EXISTS `conf__empresas_perfiles` (
  `empresa_perfil_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) unsigned DEFAULT NULL,
  `modulo_id` int(11) unsigned DEFAULT NULL,
  `perfil_id_base` int(11) unsigned DEFAULT NULL,
  `empresa_perfil_nombre` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish2_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `conf__empresas_perfiles_funciones` (
  `empresa_perfil_funcion_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `empresa_perfil_id` int(11) NOT NULL,
  `pagina_funcion_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `conf__estados_registros` (
  `estado_registro_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `estado_registro` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo_estandar` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valor_estandar` smallint(5) unsigned DEFAULT NULL,
  `color_id` tinyint(4) DEFAULT 1,
  `orden_estandar` smallint(5) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `conf__iconos` (
  `icono_id` int(11) NOT NULL AUTO_INCREMENT,
  `icono_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `icono_clase` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__imagenes
CREATE TABLE IF NOT EXISTS `conf__imagenes` (
  `imagen_id` int(11) NOT NULL AUTO_INCREMENT,
  `imagen_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `imagen_ruta` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `imagen_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `imagen_tamanio` int(11) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__localidades
CREATE TABLE IF NOT EXISTS `conf__localidades` (
  `localidad_id` int(5) unsigned NOT NULL,
  `localidad` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cp` int(4) unsigned NOT NULL,
  `provincia_id` smallint(2) unsigned DEFAULT NULL,
  `tabla_estado_registro_id` smallint(2) unsigned DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__localidades2
CREATE TABLE IF NOT EXISTS `conf__localidades2` (
  `localidad_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `provincia_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__modulos
CREATE TABLE IF NOT EXISTS `conf__modulos` (
  `modulo_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `depende_id` tinyint(4) DEFAULT 0,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__paginas
CREATE TABLE IF NOT EXISTS `conf__paginas` (
  ...
  `icono_id` int(11) NOT NULL DEFAULT 0,
  `pagina_descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `padre_id` int(10) unsigned NOT NULL DEFAULT 0,
  `orden` int(10) unsigned NOT NULL DEFAULT 0,
  `tabla_id` int(10) unsigned DEFAULT NULL,
  `pagina_patron_id` int(10) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
  `es_acceso_directo` tinyint(1) NOT NULL DEFAULT 0,
  `orden_acceso_directo` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__paginas_funciones
CREATE TABLE IF NOT EXISTS `conf__paginas_funciones` (
  `pagina_funcion_id` int(11) NOT NULL AUTO_INCREMENT,
  `pagina_id` int(11) DEFAULT NULL,
  `icono_id` int(11) DEFAULT NULL,
  `color_id` int(11) DEFAULT 1,
  `funcion_estandar_id` int(11) DEFAULT 1,
  `nombre_funcion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accion_js` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_origen_id` int(10) unsigned NOT NULL,
  `tabla_estado_registro_destino_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `conf__paginas_funciones_estandar` (
  `funcion_estandar_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.conf__paginas_funciones_tipos
CREATE TABLE IF NOT EXISTS `conf__paginas_funciones_tipos` (
  `pagina_funcion_id` int(11) NOT NULL AUTO_INCREMENT,
  `tabla_tipo_id` int(11) DEFAULT NULL,
  `icono_id` int(11) DEFAULT NULL,
  `color_id` int(11) DEFAULT 1,
  `nombre_funcion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accion_js` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_origen_id` int(10) unsigned NOT NULL DEFAULT 0,
  `tabla_estado_registro_destino_id` int(10) unsigned NOT NULL,
  `orden` int(10) unsigned DEFAULT 0,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__paginas_secciones
CREATE TABLE IF NOT EXISTS `conf__paginas_secciones` (
  `seccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `seccion_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `seccion_descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.conf__paises
...
-- Volcando estructura para tabla gestion_multipyme.conf__perfiles
CREATE TABLE IF NOT EXISTS `conf__perfiles` (
  `perfil_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `modulo_id` int(11) unsigned DEFAULT NULL,
  `perfil_nombre` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish2_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__perfiles_funciones
CREATE TABLE IF NOT EXISTS `conf__perfiles_funciones` (
  `perfil_funcion_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.conf__personas
CREATE TABLE IF NOT EXISTS `conf__personas` (
  `persona_id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario_id` int(11) NOT NULL DEFAULT 0,
  `afiliado_idx` int(11) NOT NULL DEFAULT 0,
  `apellido` varchar(150) DEFAULT NULL,
  `nombre` varchar(150) DEFAULT NULL,
  `cuil` double(22,0) unsigned NOT NULL,
  `documento_tipo_id` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `documento` varchar(50) NOT NULL,
  `domicilio` text DEFAULT NULL,
  `cod_postal` varchar(20) DEFAULT NULL,
  `ciudad` varchar(150) DEFAULT NULL,
  `provincia_id` smallint(5) unsigned DEFAULT NULL,
  `localidad_id` mediumint(10) unsigned DEFAULT 7093,
...
-- Volcando estructura para tabla gestion_multipyme.conf__provincias
CREATE TABLE IF NOT EXISTS `conf__provincias` (
  ...
  `tabla_estado_registro_id` smallint(1) unsigned DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__tablas
CREATE TABLE IF NOT EXISTS `conf__tablas` (
  `tabla_id` int(11) NOT NULL AUTO_INCREMENT,
  `tabla_nombre` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `modulo_id` int(11) unsigned DEFAULT 0,
  `tabla_tipo_id` int(11) unsigned DEFAULT 0,
  `tabla_patron_id` int(11) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__tablas_comprobantes_subgrupos
CREATE TABLE IF NOT EXISTS `conf__tablas_comprobantes_subgrupos` (
  `tabla_comprobante_subgrupo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tabla_id` int(11) unsigned NOT NULL DEFAULT 0,
  `empresa_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_subgrupo_id` int(10) unsigned NOT NULL DEFAULT 0,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__tablas_estados_registros
CREATE TABLE IF NOT EXISTS `conf__tablas_estados_registros` (
  `tabla_estado_registro_id` smallint(4) NOT NULL AUTO_INCREMENT,
  `tabla_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `tabla_estado_registro` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `color_id` tinyint(4) NOT NULL DEFAULT 1,
  `es_inicial` tinyint(1) NOT NULL DEFAULT 0,
  `orden` smallint(5) unsigned DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `conf__tablas_tipos` (
  `tabla_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
  `tabla_tipo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__tablas_tipos_estados
CREATE TABLE IF NOT EXISTS `conf__tablas_tipos_estados` (
  `tabla_tipo_estado_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tabla_tipo_id` smallint(5) unsigned DEFAULT NULL,
  `estado_registro_id` smallint(5) unsigned DEFAULT 1,
  `orden` smallint(5) unsigned DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__unidades_medida
CREATE TABLE IF NOT EXISTS `conf__unidades_medida` (
  `unidad_medida_id` int(11) NOT NULL AUTO_INCREMENT,
  `unidad_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.conf__usuarios
CREATE TABLE IF NOT EXISTS `conf__usuarios` (
  ...
  `duracion_sid_minutos` int(11) DEFAULT 60,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE IF NOT EXISTS `conf__usuarios_perfiles` (
  `usuario_perfil_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `conf__usuarios_sesiones` (
  `sid` char(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `usuario_id` int(11) NOT NULL,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.conf___perfiles_paginas
CREATE TABLE IF NOT EXISTS `conf___perfiles_paginas` (
  `perfil_pagina_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `perfil_id` int(11) unsigned DEFAULT NULL,
  `pagina_id` int(11) unsigned DEFAULT NULL COMMENT 'viene sola al elegir la función',
  `estado_registro_id` tinyint(4) DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ecom__carritos
CREATE TABLE IF NOT EXISTS `ecom__carritos` (
  `carrito_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ecom__carritos_items
CREATE TABLE IF NOT EXISTS `ecom__carritos_items` (
  `carrito_item_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ecom__login_intentos
CREATE TABLE IF NOT EXISTS `ecom__login_intentos` (
  `login_intento_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `usuario` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ecom__pedidos
CREATE TABLE IF NOT EXISTS `ecom__pedidos` (
  `ecom_pedido_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `compra_pedido_id` int(10) unsigned NOT NULL,
  `empresa_id` int(10) unsigned NOT NULL,
  `usuario_id` int(11) NOT NULL,
  `entidad_id` int(10) unsigned NOT NULL,
  `origen` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ecommerce',
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__atributos_valores
CREATE TABLE IF NOT EXISTS `gestion__atributos_valores` (
  `atributo_valor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `atributo_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__bocas
CREATE TABLE IF NOT EXISTS `gestion__bocas` (
  `boca_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `sucursal_id` smallint(5) unsigned NOT NULL,
  `es_deposito` tinyint(1) NOT NULL DEFAULT 0,
  `boca_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `orden` smallint(5) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__compras_pedidos
CREATE TABLE IF NOT EXISTS `gestion__compras_pedidos` (
  `compra_pedido_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `comprobante_tipo_id` int(11) NOT NULL,
  `comprobante_id` int(11) NOT NULL,
  `comprobante_pv` int(11) NOT NULL,
  `comprobante_nro` int(11) NOT NULL,
  `entidad_id` int(11) NOT NULL,
  `entidad_sucursal_id` int(11) DEFAULT NULL,
  `f_emision` date NOT NULL,
  `f_entrega_estimada` date DEFAULT NULL,
  `condicion_pago_id` smallint(6) NOT NULL,
  ...
  `usuario_id` int(11) NOT NULL,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__compras_pedidos_detalles
CREATE TABLE IF NOT EXISTS `gestion__compras_pedidos_detalles` (
  `compra_pedido_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `compra_pedido_id` int(11) NOT NULL,
  ...
  `iva_alicuota_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes
CREATE TABLE IF NOT EXISTS `gestion__comprobantes` (
  `comprobante_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `tabla_origen_id` int(11) NOT NULL DEFAULT 0,
  `registro_origen_id` int(11) NOT NULL,
  `modulo` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `comprobante_tipo_id` int(11) NOT NULL,
  `comprobante_pv` int(11) DEFAULT NULL,
  `comprobante_nro` int(11) NOT NULL,
  `comprobante_codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entidad_id` int(11) NOT NULL,
  `entidad_sucursal_id` int(11) DEFAULT NULL,
  `f_emision` date NOT NULL,
  ...
  `tabla_estado_registro_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_detalles` (
  `comprobante_detalle_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_detalles_relaciones
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_detalles_relaciones` (
  `relacion_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `comprobante_detalle_origen_id` bigint(20) NOT NULL,
  `comprobante_detalle_destino_id` bigint(20) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_fiscales
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_fiscales` (
  `comprobante_fiscal_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `codigo` tinyint(3) unsigned zerofill NOT NULL,
  `comprobante_fiscal` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_grupos
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_grupos` (
  `comprobante_grupo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_grupo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_impuestos
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_impuestos` (
  `comprobante_impuesto_id` int(11) NOT NULL AUTO_INCREMENT,
  `comprobante_id` int(11) NOT NULL,
  `empresa_impuesto_config_id` int(11) DEFAULT NULL,
  `tipo_origen` enum('manual','padron','regla') COLLATE utf8mb4_unicode_ci NOT NULL,
  `base_imponible` decimal(18,6) NOT NULL,
  `alicuota` decimal(10,6) NOT NULL,
  `importe` decimal(18,6) NOT NULL,
  `detalle_origen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_imputaciones
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_imputaciones` (
  `imputacion_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `comp_origen_id` int(10) unsigned NOT NULL,
  `comp_destino_id` int(10) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_numeradores
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_numeradores` (
  `numerador_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `punto_venta_id` int(11) NOT NULL,
  `comprobante_tipo_id` smallint(5) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_subgrupos` (
  `comprobante_subgrupo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_grupo_id` int(10) unsigned NOT NULL DEFAULT 0,
  `tabla_id` int(10) unsigned NOT NULL DEFAULT 0,
  `comprobante_subgrupo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comentario` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
  `tipo_asiento_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`comprobante_subgrupo_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_sucursales
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_sucursales` (
  `comprobante_sucursal_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__comprobantes_tipos
CREATE TABLE IF NOT EXISTS `gestion__comprobantes_tipos` (
  `comprobante_tipo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_grupo_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_subgrupo_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `comprobante_fiscal_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  ...
  `comprobante_tipo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `letra` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signo` enum('+','-','+/-') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+',
  `comentario` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__condiciones_fiscales
CREATE TABLE IF NOT EXISTS `gestion__condiciones_fiscales` (
  `condicion_fiscal_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `condicion_fiscal` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `condicion_fiscal_codigo` char(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `condicion_fiscal_descripcion` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__condiciones_pago
CREATE TABLE IF NOT EXISTS `gestion__condiciones_pago` (
  `condicion_pago_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `condicion_pago` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` enum('CONTADO','CUENTA_CORRIENTE') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CONTADO',
  `cantidad_cuotas` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `dias_primer_vencimiento` smallint(5) unsigned NOT NULL DEFAULT 0,
  `dias_entre_cuotas` smallint(5) unsigned NOT NULL DEFAULT 0,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_agrupaciones
CREATE TABLE IF NOT EXISTS `gestion__cont_agrupaciones` (
  `cont_agrupacion_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_agrupaciones_nodos
CREATE TABLE IF NOT EXISTS `gestion__cont_agrupaciones_nodos` (
  `cont_agrupacion_nodo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `cont_agrupacion_id` int(10) unsigned NOT NULL,
  `cont_cuenta_id` int(10) unsigned DEFAULT NULL,
  `cont_agrupacion_nodo_padre_id` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_agrupaciones_tipos
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_asientos
CREATE TABLE IF NOT EXISTS `gestion__cont_asientos` (
  `cont_asiento_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `deposito_id` int(11) NOT NULL,
  `comprobante_id` int(11) NOT NULL,
  `entidad_id` int(11) NOT NULL,
  `entidad_sucursal_id` int(11) NOT NULL,
  `cont_tipo_asiento_id` int(11) NOT NULL,
  ...
  `tabla_estado_registro_id` smallint(5) unsigned DEFAULT 3,
  PRIMARY KEY (`cont_asiento_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.gestion__cont_asientos_detalles
CREATE TABLE IF NOT EXISTS `gestion__cont_asientos_detalles` (
  `cont_asiento_id` int(11) NOT NULL,
  ...
  `comprobante_id_destino` int(11) DEFAULT NULL,
  `tipo` char(1) COLLATE utf8mb4_unicode_ci DEFAULT 'M',
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_cuentas
CREATE TABLE IF NOT EXISTS `gestion__cont_cuentas` (
  `cont_cuenta_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `comprobante_id` int(10) unsigned NOT NULL,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `naturaleza` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cuenta_padre_id` int(10) unsigned DEFAULT NULL,
  `nivel` tinyint(3) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_estructuras
CREATE TABLE IF NOT EXISTS `gestion__cont_estructuras` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `tipo` enum('area','departamento','centro_costo','proyecto') COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estructura_padre_id` int(11) DEFAULT NULL,
  `nivel` tinyint(4) DEFAULT 1,
  `tipo_registro` enum('titulo','detalle') COLLATE utf8mb4_unicode_ci DEFAULT 'titulo',
  `estado` enum('activo','inactivo') COLLATE utf8mb4_unicode_ci DEFAULT 'activo',
  PRIMARY KEY (`id`),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__cont_tipos_asientos
CREATE TABLE IF NOT EXISTS `gestion__cont_tipos_asientos` (
  `cont_tipo_asiento_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cont_tipo_asiento` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `origen` enum('manual','automatico') COLLATE utf8mb4_unicode_ci DEFAULT 'manual',
  `modulo_origen` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` tinyint(3) unsigned DEFAULT 1,
  PRIMARY KEY (`cont_tipo_asiento_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.gestion__cont_tipos_cuentas
CREATE TABLE IF NOT EXISTS `gestion__cont_tipos_cuentas` (
  `cont_tipo_cuenta_id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cont_tipo_cuenta` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__documentos_tipos
CREATE TABLE IF NOT EXISTS `gestion__documentos_tipos` (
  `tipo_documento_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mascara` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__empresas_impuestos_config
CREATE TABLE IF NOT EXISTS `gestion__empresas_impuestos_config` (
  `empresa_impuesto_config_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `impuesto_tipo_id` smallint(5) unsigned NOT NULL,
  `jurisdiccion_id` int(11) DEFAULT NULL,
  `condicion_fiscal_id` tinyint(4) unsigned DEFAULT NULL,
  `cont_cuenta_id` smallint(5) unsigned DEFAULT NULL,
  `base_calculo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alicuota` decimal(10,6) NOT NULL,
  `minimo_imponible` decimal(18,6) DEFAULT 0.000000,
  `monto_fijo` decimal(18,6) DEFAULT 0.000000,
  `aplica_siempre` tinyint(1) DEFAULT 1,
  `prioridad` smallint(6) DEFAULT 1,
  `f_desde` date NOT NULL,
  `f_hasta` date DEFAULT NULL,
  `tipo_calculo` enum('manual','padron','regla') COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__empresas_impuestos_config_operaciones
CREATE TABLE IF NOT EXISTS `gestion__empresas_impuestos_config_operaciones` (
  `empresa_impuesto_config_operacion_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_impuesto_config_id` int(11) unsigned NOT NULL,
  `producto_tipo_id` smallint(6) unsigned NOT NULL DEFAULT 0,
  `condicion_fiscal_id` smallint(6) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__empresas_impuestos_config_subgrupos
CREATE TABLE IF NOT EXISTS `gestion__empresas_impuestos_config_subgrupos` (
  `empresa_impuesto_config_subgrupo_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_impuesto_config_id` int(11) NOT NULL,
  `comprobante_subgrupo_id` int(11) NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades
CREATE TABLE IF NOT EXISTS `gestion__entidades` (
  `entidad_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
  `entidad_nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entidad_fantasia` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entidad_tipo_id` tinyint(3) unsigned DEFAULT NULL,
  `cuit` bigint(20) unsigned DEFAULT NULL,
  `sitio_web` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `domicilio_legal` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `localidad_id` int(11) DEFAULT NULL,
  `cont_cuenta_id_proveedor` int(11) DEFAULT NULL,
  `cont_cuenta_id_cliente` int(11) DEFAULT NULL,
  `es_proveedor` tinyint(4) DEFAULT 0,
  `es_cliente` tinyint(4) DEFAULT 0,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_clientes_tipos
CREATE TABLE IF NOT EXISTS `gestion__entidades_clientes_tipos` (
  `entidad_cliente_tipo_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `entidad_cliente_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo_estandar` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_condiciones_clientes
CREATE TABLE IF NOT EXISTS `gestion__entidades_condiciones_clientes` (
  `entidad_condicion_cliente_id` int(11) NOT NULL AUTO_INCREMENT,
  `entidad_id` int(11) NOT NULL,
  `condicion_pago_id` int(11) DEFAULT NULL,
  `entidad_cliente_tipo_id` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_condiciones_fiscales
CREATE TABLE IF NOT EXISTS `gestion__entidades_condiciones_fiscales` (
  `entidad_condicion_fiscal_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `entidad_id` int(10) unsigned NOT NULL,
  `condicion_fiscal_id` int(10) unsigned NOT NULL,
  `f_desde` date NOT NULL,
  `f_hasta` date DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_condiciones_proveedores
CREATE TABLE IF NOT EXISTS `gestion__entidades_condiciones_proveedores` (
  `entidad_condicion_proveedor_id` int(11) NOT NULL AUTO_INCREMENT,
  `entidad_id` int(11) NOT NULL,
  `condicion_pago_id` int(11) DEFAULT NULL,
  `proveedor_categoria_id` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_impuestos_padron
CREATE TABLE IF NOT EXISTS `gestion__entidades_impuestos_padron` (
  `entidad_impuesto_padron_id` int(11) NOT NULL AUTO_INCREMENT,
  `entidad_id` int(11) NOT NULL,
  `impuesto_jurisdiccion_id` int(11) NOT NULL,
  `alicuota` decimal(10,6) NOT NULL,
  `tipo_contribuyente` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `f_desde` date NOT NULL,
  `f_hasta` date DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_listas_precios
CREATE TABLE IF NOT EXISTS `gestion__entidades_listas_precios` (
  `entidad_lista_precio_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `entidad_id` int(10) unsigned NOT NULL,
  `lista_precio_id` int(10) unsigned NOT NULL,
  `f_desde` date NOT NULL,
  `f_hasta` date DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_roles
CREATE TABLE IF NOT EXISTS `gestion__entidades_roles` (
  `entidad_rol_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `entidad_id` int(10) unsigned NOT NULL,
  `rol_entidad_id` tinyint(3) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_sucursales
CREATE TABLE IF NOT EXISTS `gestion__entidades_sucursales` (
  `sucursal_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `entidad_id` int(10) unsigned NOT NULL,
  `empresa_id` int(10) unsigned NOT NULL,
  `sucursal_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sucursal_direccion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `localidad_id` int(10) unsigned DEFAULT NULL,
  `sucursal_telefono` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sucursal_email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sucursal_contacto` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_sucursales_compra
CREATE TABLE IF NOT EXISTS `gestion__entidades_sucursales_compra` (
  `entidad_sucursal_compra_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `entidad_id` int(10) unsigned NOT NULL,
  `sucursal_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__entidades_tipos
CREATE TABLE IF NOT EXISTS `gestion__entidades_tipos` (
  `entidad_tipo_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__facturas_proveedores
CREATE TABLE IF NOT EXISTS `gestion__facturas_proveedores` (
  ...
  `comprobante_pv` int(11) DEFAULT NULL,
  `comprobante_nro` int(11) NOT NULL DEFAULT 0,
  `entidad_id` int(11) NOT NULL,
  `entidad_sucursal_id` int(11) DEFAULT NULL,
  `f_emision` date NOT NULL,
  `f_contabilidad` date DEFAULT NULL,
  ...
  `observaciones` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` int(11) NOT NULL DEFAULT 3,
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_modificacion` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__facturas_proveedores_detalle
CREATE TABLE IF NOT EXISTS `gestion__facturas_proveedores_detalle` (
  `factura_proveedor_detalle_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `iva_alicuota_id` int(11) DEFAULT NULL,
  ...
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 0,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__impuestos_jurisdicciones
CREATE TABLE IF NOT EXISTS `gestion__impuestos_jurisdicciones` (
  `impuesto_jurisdiccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `impuesto_tipo_id` smallint(5) unsigned NOT NULL,
  `jurisdiccion_id` int(11) NOT NULL,
  `tipo_calculo` enum('manual','padron','regla') COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo_local` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `requiere_padron` tinyint(1) DEFAULT 0,
  `cuenta_contable_id` int(11) DEFAULT NULL,
  `orden` smallint(6) DEFAULT 1,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__impuestos_tipos
CREATE TABLE IF NOT EXISTS `gestion__impuestos_tipos` (
  `impuesto_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `impuesto_tipo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo_afip` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__impuestos__iva_alicuotas
CREATE TABLE IF NOT EXISTS `gestion__impuestos__iva_alicuotas` (
  `iva_alicuota_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `codigo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `iva_alicuota` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `cont_cuenta_compra_id` int(11) NOT NULL DEFAULT 0,
  `cont_cuenta_venta_id` int(11) NOT NULL DEFAULT 0,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__jurisdicciones
CREATE TABLE IF NOT EXISTS `gestion__jurisdicciones` (
  `jurisdiccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `jurisdiccion_codigo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jurisdiccion_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pais_id` int(11) NOT NULL,
  `provincia_id` int(11) DEFAULT NULL,
  `localidad_id` int(11) DEFAULT NULL,
  `jurisdiccion_tipo_id` smallint(5) unsigned NOT NULL,
  `organismo_recaudador` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `requiere_padron` tinyint(1) DEFAULT 0,
  `codigo_externo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(6) DEFAULT 1,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__jurisdicciones_tipos
CREATE TABLE IF NOT EXISTS `gestion__jurisdicciones_tipos` (
  `jurisdiccion_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `jurisdiccion_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(6) DEFAULT 1,
  `tabla_estado_registro_id` smallint(6) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios
CREATE TABLE IF NOT EXISTS `gestion__listas_precios` (
  `lista_precio_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `lista_precio_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lista_precio_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lista_precio_origen_id` smallint(5) unsigned NOT NULL,
  `lista_base_id` int(10) unsigned DEFAULT NULL,
  `moneda_id` smallint(5) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios_origenes
CREATE TABLE IF NOT EXISTS `gestion__listas_precios_origenes` (
  `lista_precio_origen_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `lista_precio_origen_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lista_precio_origen_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios_productos
CREATE TABLE IF NOT EXISTS `gestion__listas_precios_productos` (
  `lista_precio_producto_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `lista_precio_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `producto_costo_id` int(10) unsigned DEFAULT NULL,
  ...
  `lista_precio_regla_id` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios_productos_historial
CREATE TABLE IF NOT EXISTS `gestion__listas_precios_productos_historial` (
  `lista_precio_producto_historial_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `lista_precio_id` int(10) unsigned NOT NULL,
  `lista_precio_producto_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `producto_costo_id` int(10) unsigned DEFAULT NULL,
  `precio_origen` decimal(18,6) NOT NULL DEFAULT 0.000000,
  `porcentaje_general_aplicado` decimal(10,6) NOT NULL DEFAULT 0.000000,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios_reglas
CREATE TABLE IF NOT EXISTS `gestion__listas_precios_reglas` (
  `lista_precio_regla_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `lista_precio_id` int(10) unsigned NOT NULL,
  `regla_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lista_precio_regla_valor_tipo_id` smallint(5) unsigned NOT NULL,
  ...
  `submodelo_id` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__listas_precios_reglas_valores_tipos
CREATE TABLE IF NOT EXISTS `gestion__listas_precios_reglas_valores_tipos` (
  `lista_precio_regla_valor_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `lista_precio_regla_valor_tipo_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lista_precio_regla_valor_tipo_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned NOT NULL DEFAULT 1,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__logs
...
-- Volcando estructura para tabla gestion_multipyme.gestion__marcas
...
-- Volcando estructura para tabla gestion_multipyme.gestion__modelos
CREATE TABLE IF NOT EXISTS `gestion__modelos` (
  ...
  `modelo_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__monedas
CREATE TABLE IF NOT EXISTS `gestion__monedas` (
  `moneda_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `codigo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `cantidad_decimales` tinyint(3) unsigned NOT NULL DEFAULT 2,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ordenes_compra
CREATE TABLE IF NOT EXISTS `gestion__ordenes_compra` (
  ...
  `comprobante_tipo_id` int(11) NOT NULL,
  `punto_venta_id` int(11) NOT NULL,
  `comprobante_nro` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entidad_id` int(11) NOT NULL,
  `entidad_sucursal_id` int(11) DEFAULT NULL,
  `f_emision` date NOT NULL,
  `f_entrega_estimada` date DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ordenes_compra_detalle
CREATE TABLE IF NOT EXISTS `gestion__ordenes_compra_detalle` (
  `ordenes_compra_detalle_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__perfiles_sucursales
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos
CREATE TABLE IF NOT EXISTS `gestion__productos` (
  ...
  `producto_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo_barras` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `producto_descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `producto_categoria_id` int(10) unsigned NOT NULL DEFAULT 1,
  `cont_cuenta_id` int(10) unsigned NOT NULL,
  `producto_tipo_id` int(10) unsigned NOT NULL DEFAULT 1,
  `lado` char(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `controla_stock` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `es_servicio` tinyint(1) NOT NULL DEFAULT 0,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
  `compatibilidad_texto` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Materializado: marca+modelo+submodelo+año, para MOSTRAR en grillas sin recalcular en cada consulta',
  `compatibilidad_busqueda` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Materializado: igual a compatibilidad_texto pero con cada año del rango expandido, para que BUSCAR un año intermedio matchee',
  `proveedores_busqueda` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_categorias
CREATE TABLE IF NOT EXISTS `gestion__productos_categorias` (
  `producto_categoria_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
  `producto_categoria_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto_categoria_padre_id` int(10) unsigned DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
  `producto_tipo_id` int(11) unsigned DEFAULT 1,
  `cont_cuenta_ingreso_id` int(11) DEFAULT NULL,
  `cont_cuenta_cmv_id` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_combos
CREATE TABLE IF NOT EXISTS `gestion__productos_combos` (
  `producto_combo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `combo_nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metodo_precio_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PRECIO_FIJO',
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_combos_detalles
CREATE TABLE IF NOT EXISTS `gestion__productos_combos_detalles` (
  `producto_combo_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_combo_id` int(10) unsigned NOT NULL,
  `producto_componente_id` int(10) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_compatibilidad
CREATE TABLE IF NOT EXISTS `gestion__productos_compatibilidad` (
  ...
  `submodelo_id` int(10) unsigned DEFAULT NULL,
  `anio_desde` year(4) NOT NULL DEFAULT 2000,
  `anio_hasta` year(4) DEFAULT 2100,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos
CREATE TABLE IF NOT EXISTS `gestion__productos_costos` (
  `producto_costo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `entidad_id` int(10) unsigned NOT NULL,
  `costo_actual` decimal(18,6) NOT NULL DEFAULT 0.000000,
  `moneda_id` smallint(5) unsigned DEFAULT NULL,
  `producto_costo_origen_id` smallint(5) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_ajustes
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_ajustes` (
  `producto_costo_ajuste_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_costo_ajuste_tipo_id` smallint(5) unsigned NOT NULL,
  `producto_costo_ajuste_valor_tipo_id` smallint(5) unsigned DEFAULT NULL,
  `ajuste_descripcion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `valor_ajuste` decimal(18,6) DEFAULT NULL,
  `entidad_id` int(10) unsigned DEFAULT NULL,
  `producto_id` int(10) unsigned DEFAULT NULL,
  `proveedor_lista_costo_id` int(10) unsigned DEFAULT NULL,
  `comprobante_id` int(10) unsigned DEFAULT NULL,
  ...
  `aplicado_por` int(10) unsigned DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `creado_por` int(10) unsigned DEFAULT NULL,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_ajustes_detalles
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_ajustes_detalles` (
  `producto_costo_ajuste_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `producto_costo_ajuste_id` int(10) unsigned NOT NULL,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `costo_anterior` decimal(18,6) DEFAULT NULL,
  `valor_ajuste` decimal(18,6) DEFAULT NULL,
  `costo_nuevo` decimal(18,6) NOT NULL DEFAULT 0.000000,
  `producto_costo_historial_id` int(10) unsigned DEFAULT NULL,
  `proveedor_lista_costo_detalle_id` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_ajustes_tipos
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_ajustes_tipos` (
  `producto_costo_ajuste_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `producto_costo_ajuste_tipo_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto_costo_ajuste_tipo_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned NOT NULL DEFAULT 1,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_ajustes_valores_tipos
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_ajustes_valores_tipos` (
  `producto_costo_ajuste_valor_tipo_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `producto_costo_ajuste_valor_tipo_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto_costo_ajuste_valor_tipo_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned NOT NULL DEFAULT 1,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_historial
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_historial` (
  `producto_costo_historial_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `entidad_id` int(10) unsigned NOT NULL,
  `costo_anterior` decimal(18,6) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_costos_origenes
CREATE TABLE IF NOT EXISTS `gestion__productos_costos_origenes` (
  `producto_costo_origen_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `producto_costo_origen_codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto_costo_origen_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orden` smallint(5) unsigned NOT NULL DEFAULT 1,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL DEFAULT 1,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_imagenes
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_locaciones
CREATE TABLE IF NOT EXISTS `gestion__productos_locaciones` (
  `producto_locacion_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `producto_id` bigint(20) unsigned NOT NULL,
  `sucursal_id` smallint(5) unsigned NOT NULL,
  `local_id` smallint(5) unsigned NOT NULL,
  `seccion_id` bigint(20) unsigned NOT NULL,
  `estanteria_id` bigint(20) unsigned NOT NULL,
  `estante_id` bigint(20) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_proveedores
CREATE TABLE IF NOT EXISTS `gestion__productos_proveedores` (
  `producto_proveedor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `producto_id` int(10) unsigned NOT NULL DEFAULT 0,
  `entidad_id` mediumint(8) unsigned NOT NULL DEFAULT 0,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_proveedores_precios
CREATE TABLE IF NOT EXISTS `gestion__productos_proveedores_precios` (
  `producto_proveedor_precio_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `producto_proveedor_id` bigint(20) unsigned NOT NULL,
  `empresa_id` int(10) unsigned NOT NULL,
  `entidad_id` mediumint(8) unsigned NOT NULL,
  `precio_lista` decimal(14,4) NOT NULL,
  `moneda_id` smallint(6) NOT NULL DEFAULT 1,
  `f_vigencia_desde` date NOT NULL,
  `origen_carga` enum('MANUAL','IMPORTACION') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MANUAL',
  `archivo_importacion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usuario_carga_id` int(10) unsigned NOT NULL,
  `usuario_modificacion_id` int(10) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_proveedores_precios_historico
CREATE TABLE IF NOT EXISTS `gestion__productos_proveedores_precios_historico` (
  `producto_proveedor_precio_historico_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `producto_proveedor_id` bigint(20) unsigned NOT NULL,
  `precio_lista` decimal(14,4) NOT NULL,
  `moneda_id` smallint(6) NOT NULL,
  `f_vigencia_desde` date NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_tipos
CREATE TABLE IF NOT EXISTS `gestion__productos_tipos` (
  `producto_tipo_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) unsigned NOT NULL DEFAULT 0,
  `producto_tipo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `producto_tipo_codigo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `maneja_stock` tinyint(1) unsigned DEFAULT 0,
  `es_compuesto` tinyint(1) unsigned DEFAULT 0,
  `afecta_facturacion` tinyint(1) unsigned DEFAULT 1,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__productos_ubicaciones
CREATE TABLE IF NOT EXISTS `gestion__productos_ubicaciones` (
  `producto_ubicacion_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `producto_id` bigint(20) unsigned NOT NULL,
  `sucursal_ubicacion_id` int(10) unsigned NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__proveedores_categorias
CREATE TABLE IF NOT EXISTS `gestion__proveedores_categorias` (
  `proveedor_categoria_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__puntos_venta
CREATE TABLE IF NOT EXISTS `gestion__puntos_venta` (
  `punto_venta_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL DEFAULT 0,
  `sucursal_id` smallint(5) unsigned NOT NULL,
  `boca_id` smallint(5) unsigned DEFAULT NULL,
  `nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo_fiscal` int(11) DEFAULT NULL,
  `es_web` tinyint(1) unsigned NOT NULL DEFAULT 0 COMMENT 'Indica si este registro es el punto de venta web (1) o físico/otro (0)',
  `fecha_creacion` datetime DEFAULT current_timestamp(),
  `usuario_creacion_id` bigint(20) unsigned DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__puntos_venta_comprobantes
CREATE TABLE IF NOT EXISTS `gestion__puntos_venta_comprobantes` (
  `punto_venta_comprobante_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `punto_venta_id` int(11) NOT NULL,
  `comprobante_tipo_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__roles_entidades
CREATE TABLE IF NOT EXISTS `gestion__roles_entidades` (
  `rol_entidad_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `rol_entidad_codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol_entidad_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol_entidad_descripcion` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rol_entidad_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.gestion__stock
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_ajustes
CREATE TABLE IF NOT EXISTS `gestion__stock_ajustes` (
  `stock_ajuste_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `sucursal_id` smallint(5) unsigned NOT NULL,
  `deposito_id` int(10) unsigned NOT NULL,
  `comprobante_tipo_id` int(10) unsigned NOT NULL,
  `fecha` datetime NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stock_movimiento_id` bigint(20) unsigned DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_ajustes_detalles
CREATE TABLE IF NOT EXISTS `gestion__stock_ajustes_detalles` (
  `stock_ajuste_detalle_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `stock_ajuste_id` bigint(20) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `deposito_id` int(10) unsigned NOT NULL,
  ...
  `stock_movimiento_tipo_id` tinyint(3) unsigned DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_movimientos
CREATE TABLE IF NOT EXISTS `gestion__stock_movimientos` (
  `stock_movimiento_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL,
  `sucursal_id` int(10) unsigned NOT NULL,
  `deposito_id` int(10) unsigned NOT NULL,
  `comprobante_tipo_id` int(10) unsigned DEFAULT NULL,
  `comprobante_id` bigint(20) unsigned DEFAULT NULL,
  `stock_movimiento_tipo_id` tinyint(3) unsigned NOT NULL,
  `fecha` datetime NOT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL,
  `f_alta` datetime DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_movimientos_detalles
CREATE TABLE IF NOT EXISTS `gestion__stock_movimientos_detalles` (
  `stock_movimiento_detalle_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `stock_movimiento_id` bigint(20) unsigned NOT NULL,
  `producto_id` int(10) unsigned NOT NULL,
  `cantidad` decimal(20,2) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_movimientos_tipos
CREATE TABLE IF NOT EXISTS `gestion__stock_movimientos_tipos` (
  `stock_movimiento_tipo_id` tinyint(4) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__stock_recepciones
CREATE TABLE IF NOT EXISTS `gestion__stock_recepciones` (
  `stock_recepcion_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `comprobante_id` int(11) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__submodelos
CREATE TABLE IF NOT EXISTS `gestion__submodelos` (
  `submodelo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
  `modelo_id` int(10) unsigned NOT NULL,
  `submodelo_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__sucursales
CREATE TABLE IF NOT EXISTS `gestion__sucursales` (
  `sucursal_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` smallint(5) unsigned NOT NULL,
  `sucursal_tipo_id` tinyint(3) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__sucursales_tipos
CREATE TABLE IF NOT EXISTS `gestion__sucursales_tipos` (
  `sucursal_tipo_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) NOT NULL DEFAULT 0,
  `sucursal_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__sucursales_ubicaciones
CREATE TABLE IF NOT EXISTS `gestion__sucursales_ubicaciones` (
  `sucursal_ubicacion_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
  `sucursal_id` smallint(5) unsigned NOT NULL,
  `boca_id` smallint(5) unsigned NOT NULL,
  `seccion` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estanteria` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estante` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__unidades_medida
CREATE TABLE IF NOT EXISTS `gestion__unidades_medida` (
  `unidad_medida_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(10) unsigned NOT NULL DEFAULT 0,
  `unidad_nombre` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unidad_abreviatura` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(4) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_facturas
CREATE TABLE IF NOT EXISTS `gestion__ventas_facturas` (
  `venta_factura_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `comprobante_tipo_id` int(11) NOT NULL,
  `punto_venta_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion__ventas_facturas_detalles` (
  `venta_factura_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `venta_factura_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `venta_remito_detalle_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion__ventas_pedidos` (
  `venta_pedido_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `comprobante_tipo_id` int(11) NOT NULL,
  `comprobante_id` int(11) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_pedidos_detalles
CREATE TABLE IF NOT EXISTS `gestion__ventas_pedidos_detalles` (
  `venta_pedido_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `venta_pedido_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `cantidad` decimal(15,4) NOT NULL,
  `cantidad_entregada` decimal(15,4) NOT NULL,
  `facturado` decimal(15,4) NOT NULL,
  `precio_unitario` decimal(18,6) NOT NULL,
  `descuento_item_pct` decimal(5,2) NOT NULL,
  `descuento_general_pct` decimal(5,2) NOT NULL COMMENT 'viene de la tabla de condiciones de clientes',
  `descuento_general` decimal(20,2) NOT NULL COMMENT 'precio_unitario*descuento_general_pct',
  `descuento_item` decimal(20,2) NOT NULL,
  `precio_unitario_bruto` decimal(18,6) NOT NULL,
  `precio_unitario_neto` decimal(18,6) NOT NULL COMMENT 'precio_unitario-descuento_general',
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_presupuestos
CREATE TABLE IF NOT EXISTS `gestion__ventas_presupuestos` (
  `venta_presupuesto_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `comprobante_id` int(11) NOT NULL,
  `entidad_id` int(11) NOT NULL,
  ...
  `total` decimal(18,2) NOT NULL DEFAULT 0.00,
  `convertido_a_pedido_id` int(11) DEFAULT NULL,
  `convertido_a_factura_id` int(11) DEFAULT NULL,
  `usuario_id` int(11) NOT NULL,
  `tabla_estado_registro_id` smallint(5) unsigned NOT NULL,
  `observaciones` text DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_presupuestos_detalles
CREATE TABLE IF NOT EXISTS `gestion__ventas_presupuestos_detalles` (
  `venta_presupuesto_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `venta_presupuesto_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `cantidad` decimal(15,4) NOT NULL,
  `precio_unitario` decimal(18,6) NOT NULL,
  `iva_alicuota_id` smallint(5) unsigned NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_remitos
CREATE TABLE IF NOT EXISTS `gestion__ventas_remitos` (
  `venta_remito_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `empresa_id` int(11) NOT NULL,
  `sucursal_id` int(11) NOT NULL,
  `boca_id` smallint(5) unsigned NOT NULL,
  `comprobante_tipo_id` int(11) NOT NULL,
  ...
  KEY `sucursal_id` (`sucursal_id`),
  KEY `tabla_estado_registro_id` (`tabla_estado_registro_id`),
  KEY `idx_boca` (`boca_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.gestion__ventas_remitos_detalles
CREATE TABLE IF NOT EXISTS `gestion__ventas_remitos_detalles` (
  `venta_remito_detalle_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `venta_remito_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `venta_pedido_detalle_id` int(11) DEFAULT NULL,
  `cantidad` decimal(15,4) NOT NULL,
  ...
  `iva_alicuota_id` smallint(5) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ml__ambitos_organizacionales` (
  `ambito_id` int(11) NOT NULL AUTO_INCREMENT,
  `ambito_tipo_id` int(11) NOT NULL,
  `ambito_padre_id` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__ambitos_tipos
CREATE TABLE IF NOT EXISTS `ml__ambitos_tipos` (
  `ambito_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
  `ambito_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) unsigned DEFAULT 1,
  PRIMARY KEY (`ambito_tipo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla gestion_multipyme.ml__entidades
CREATE TABLE IF NOT EXISTS `ml__entidades` (
  `entidad_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_ambito_id` int(11) NOT NULL,
  `entidad_tipo_id` int(11) NOT NULL,
  `entidad_padre_id` int(11) DEFAULT NULL,
  `codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jurisdiccion_id` int(11) DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__entidades_tipos
CREATE TABLE IF NOT EXISTS `ml__entidades_tipos` (
  `entidad_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ml__jurisdicciones
CREATE TABLE IF NOT EXISTS `ml__jurisdicciones` (
  `jurisdiccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `jurisdiccion_tipo_id` int(11) NOT NULL,
  `jurisdiccion_padre_id` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__jurisdicciones_tipos
CREATE TABLE IF NOT EXISTS `ml__jurisdicciones_tipos` (
  `jurisdiccion_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
  `jurisdiccion_tipo` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
  PRIMARY KEY (`jurisdiccion_tipo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Volcando estructura para tabla gestion_multipyme.ml__normas
CREATE TABLE IF NOT EXISTS `ml__normas` (
  `norma_id` int(11) NOT NULL AUTO_INCREMENT,
  `ambito_definicion_id` int(11) NOT NULL,
  `norma_tipo_id` int(11) NOT NULL,
  `codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `titulo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `organismo_emisor` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__normas_ambitos_aplicacion
CREATE TABLE IF NOT EXISTS `ml__normas_ambitos_aplicacion` (
  `norma_ambito_aplicacion_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ml__normas_procedimientos
CREATE TABLE IF NOT EXISTS `ml__normas_procedimientos` (
  `norma_procedimiento_id` int(11) NOT NULL AUTO_INCREMENT,
  `norma_id` int(11) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__normas_tipos
CREATE TABLE IF NOT EXISTS `ml__normas_tipos` (
  `norma_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
  `norma_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__obligaciones
CREATE TABLE IF NOT EXISTS `ml__obligaciones` (
  `obligacion_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_ambito_id` int(11) NOT NULL,
  `norma_id` int(11) NOT NULL,
  `codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_obligacion` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frecuencia_tipo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frecuencia_cada` int(11) DEFAULT NULL,
  `criterio_cumplimiento` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo_evidencia_requerida` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__obligaciones_jurisdicciones
CREATE TABLE IF NOT EXISTS `ml__obligaciones_jurisdicciones` (
  `obligacion_jurisdiccion_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ml__obligaciones_raci
CREATE TABLE IF NOT EXISTS `ml__obligaciones_raci` (
  `obligacion_raci_id` int(11) NOT NULL AUTO_INCREMENT,
  `obligacion_id` int(11) NOT NULL,
  `rol_organizacional_id` int(11) NOT NULL,
  `raci_tipo_id` int(11) NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__obligaciones_tipos_entidades
CREATE TABLE IF NOT EXISTS `ml__obligaciones_tipos_entidades` (
  `obligacion_tipo_entidad_id` int(11) NOT NULL AUTO_INCREMENT,
  `obligacion_id` int(11) NOT NULL,
  `entidad_tipo_id` int(11) NOT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__procedimientos
CREATE TABLE IF NOT EXISTS `ml__procedimientos` (
  ...
  `alcance` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_aprobacion` date DEFAULT NULL,
  `area_responsable` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__procedimientos_instrucciones
CREATE TABLE IF NOT EXISTS `ml__procedimientos_instrucciones` (
  `procedimiento_instruccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `procedimiento_id` int(11) NOT NULL,
  `orden` int(11) NOT NULL,
  `titulo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion_paso` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `evidencia_requerida` tinyint(1) NOT NULL DEFAULT 0,
  `tipo_evidencia_sugerida` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__procedimientos_obligaciones
CREATE TABLE IF NOT EXISTS `ml__procedimientos_obligaciones` (
  `procedimiento_obligacion_id` int(11) NOT NULL AUTO_INCREMENT,
  `obligacion_id` int(11) NOT NULL,
  `procedimiento_id` int(11) NOT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tabla_estado_registro_id` smallint(6) NOT NULL DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.ml__raci_tipos
CREATE TABLE IF NOT EXISTS `ml__raci_tipos` (
  `raci_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.ml__roles_organizacionales
CREATE TABLE IF NOT EXISTS `ml__roles_organizacionales` (
  `rol_organizacional_id` int(11) NOT NULL AUTO_INCREMENT,
  `empresa_ambito_id` int(11) NOT NULL,
  `codigo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__tareas
CREATE TABLE IF NOT EXISTS `ml__tareas` (
  ...
  `estado_tarea` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__tareas_ciclos
...
-- Volcando estructura para tabla gestion_multipyme.ml__tareas_dependencias
CREATE TABLE IF NOT EXISTS `ml__tareas_dependencias` (
  `tarea_dependencia_id` int(11) NOT NULL AUTO_INCREMENT,
  `tarea_origen_id` int(11) NOT NULL,
  `tarea_destino_id` int(11) NOT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.ml__tareas_evidencias
CREATE TABLE IF NOT EXISTS `ml__tareas_evidencias` (
  `tarea_evidencia_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.provincias
CREATE TABLE IF NOT EXISTS `provincias` (
  `provincia_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `provincia` varchar(150) DEFAULT NULL,
  `estado_registro_id` smallint(1) unsigned DEFAULT 1,
  PRIMARY KEY (`provincia_id`),
  KEY `id_localidad` (`provincia_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Volcando estructura para tabla gestion_multipyme.xxx_conf__tablas_estados
CREATE TABLE IF NOT EXISTS `xxx_conf__tablas_estados` (
  `tabla_estado_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tabla_id` int(11) unsigned NOT NULL,
  `tabla_estado` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `color_id` tinyint(4) NOT NULL DEFAULT 1,
  `estado_registro_id` int(11) unsigned NOT NULL,
  `orden` smallint(5) unsigned DEFAULT 1,
  `valor` smallint(5) unsigned DEFAULT 1,
...
-- Volcando estructura para tabla gestion_multipyme.xxx_gestion__listas_precios
CREATE TABLE IF NOT EXISTS `xxx_gestion__listas_precios` (
  `lista_precio_id` int(11) NOT NULL AUTO_INCREMENT,
  `lista_precio` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `empresa_id` int(11) DEFAULT NULL,
  `lista_base_id` int(11) DEFAULT NULL,
  `es_principal` tinyint(1) NOT NULL DEFAULT 0,
  `metodo_calculo` enum('manual','automatico') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `margen_ganancia` decimal(5,2) NOT NULL DEFAULT 0.00,
  `tipo` enum('venta','compra') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'venta',
  ...
  `usuario_id_alta` int(11) DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.xxx_gestion__listas_precios_ajustes
CREATE TABLE IF NOT EXISTS `xxx_gestion__listas_precios_ajustes` (
  `ajuste_id` int(11) NOT NULL AUTO_INCREMENT,
  `lista_id` int(11) NOT NULL,
  `tipo_ajuste` enum('lote','individual','automatico') COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proveedor_id` int(11) DEFAULT NULL,
  `producto_id` int(11) DEFAULT 0,
  `producto_categoria_id` int(11) DEFAULT 0,
  `marca_id` int(11) DEFAULT 0,
  `modelo_id` int(11) DEFAULT 0,
  `submodelo_id` int(11) DEFAULT 0,
  `porcentaje` decimal(7,4) DEFAULT NULL,
  `monto_fijo` decimal(15,2) DEFAULT NULL,
  `criterio` enum('aumento','reduccion','reemplazo') COLLATE utf8mb4_unicode_ci DEFAULT 'aumento',
  `f_alta` datetime NOT NULL DEFAULT current_timestamp(),
  `usuario_id_alta` int(11) DEFAULT NULL,
  `ip_origen` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando estructura para tabla gestion_multipyme.xxx_gestion__listas_precios_productos
CREATE TABLE IF NOT EXISTS `xxx_gestion__listas_precios_productos` (
  `lista_precio_producto_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla gestion_multipyme.xxx_gestion__listas_precios_productos_historial
CREATE TABLE IF NOT EXISTS `xxx_gestion__listas_precios_productos_historial` (
  `lista_precio_producto_historial_id` int(11) NOT NULL AUTO_INCREMENT,
  `lista_precio_producto_id` int(11) NOT NULL,
  `lista_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `precio_unitario` decimal(15,2) NOT NULL,
