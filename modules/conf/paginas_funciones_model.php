...
function obtenerPaginasFunciones($conexion) {
    $sql = "SELECT pf.*, p.pagina, t.tabla_nombre, 
            ...
            LEFT JOIN conf__estados_registros eo ON pf.estado_registro_origen_id = eo.estado_registro_id
            LEFT JOIN conf__estados_registros ed ON pf.estado_registro_destino_id = ed.estado_registro_id
...
function obtenerEstadosPorTabla($conexion, $tabla_id) {
    ...
    $sql = "SELECT er.estado_registro_id, er.estado_registro 
            ...
            LEFT JOIN conf__estados_registros er ON te.estado_registro_id = er.estado_registro_id
...
function agregarPaginaFuncion($conexion, $data) {
    ...
    $sql = "INSERT INTO conf__paginas_funciones 
            (pagina_id, tabla_id, nombre_funcion, descripcion, estado_registro_origen_id, estado_registro_destino_id, es_confirmable, orden) 
