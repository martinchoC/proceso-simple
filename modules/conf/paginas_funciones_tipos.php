...
$pageTitle = "Gestión de Tipos de Funciones de Páginas";
...
<main class="app-main">
    ...
    <div class="app-content-header">
        ...
        <!--begin::Row-->
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Tipos de Funciones de Páginas</h3></div>
            <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">                                
                                <div class="card-body">
                                    ...
                                    <table id="tablaFuncionesTipos" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Tipo Tabla</th>
...
<!-- Modal -->
<div class="modal fade" id="modalFuncionTipo" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Tipo de Función</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
      </div>
      <div class="modal-body">
        <form id="formFuncionTipo">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="tabla_tipo_id" name="tabla_tipo_id">
...
// Función para cargar tipos de tablas
function cargarTablasTipos(selectedId = null) {
    $.ajax({
        url: 'paginas_funciones_tipos_ajax.php',
        type: 'GET',
        data: {accion: 'obtenerTablasTipos'},
        dataType: 'json',
        ...
        error: function() {
            console.error('Error al cargar tipos de tablas');
...
$(document).ready(function(){
    ...
    $('#color_id').change(function() {
        ...
        if (colorId) {
            // Obtener la clase de color seleccionada
            var selectedOption = $(this).find('option:selected');
            var colorClass = selectedOption.text().toLowerCase().includes('outline') 
                ? selectedOption.text().toLowerCase().replace('outline ', 'btn-outline-').replace(' primario', '-primary').replace(' secundario', '-secondary')
                : 'btn-' + selectedOption.text().toLowerCase();
    ...
    var tabla = $('#tablaFuncionesTipos').DataTable({
        pageLength: 25,
    ...
    $('#btnNuevo').click(function(){
        ...
        var modal = new bootstrap.Modal(document.getElementById('modalFuncionTipo'));
        modal.show();
    });

    $('#tablaFuncionesTipos tbody').on('click', '.btnEditar', function(){
        ...
        $.get('paginas_funciones_tipos_ajax.php', {accion: 'obtener', pagina_funcion_id: data.pagina_funcion_id}, function(res){
            if(res){
                ...
                cargarTablasTipos(res.tabla_tipo_id);
    ...
    $('#tablaFuncionesTipos tbody').on('click', '.btnEliminar', function(){
        Swal.fire({
            title: "¿Estás seguro?",
            ...
            if (result.isConfirmed) {
                var data = tabla.row($(this).parents('tr')).data();
                $.get('paginas_funciones_tipos_ajax.php', {accion: 'eliminar', pagina_funcion_id: data.pagina_funcion_id}, function(res){
                    if(res.resultado){
                        tabla.ajax.reload();
                        Swal.fire({                    
                            icon: "success",
    ...
    $('#btnGuardar').click(function(){
        ...
        if ($('#nombre_funcion').val().trim() === '' || 
            ...
            $('#formFuncionTipo').addClass('was-validated');
            Swal.fire({
                icon: 'warning',
        ...
        $.ajax({
            ...
            success: function(res) {
                if(res.resultado) {
                    ...
                    var modal = bootstrap.Modal.getInstance(document.getElementById('modalFuncionTipo'));
                    modal.hide();
                    ...
                    updateButtonPreviews('btn-primary', 'fa-cog', 'Función');
                    updateColorPreview('btn-primary');
                    $('#formFuncionTipo').removeClass('was-validated');
