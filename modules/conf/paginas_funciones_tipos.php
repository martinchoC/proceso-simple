        ...
        <form id="formPaginaFuncion">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="tabla_estado_registro_origen_id" name="tabla_estado_registro_origen_id">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="tabla_estado_registro_destino_id" name="tabla_estado_registro_destino_id">
...
$(document).ready(function(){
    ...
    function cargarEstadosPorTabla(tabla_id) {
        if (!tabla_id) {
            $('#tabla_estado_registro_origen_id, #tabla_estado_registro_destino_id').empty().append('<option value="">Seleccionar estado</option>');
            return;
        }
        ...
        $.get('paginas_funciones_ajax.php', {accion: 'obtener_estados_por_tabla', tabla_id: tabla_id}, function(res){
            if(res && res.length > 0) {
                ...
                $.each(res, function(i, estado) {
                    $('#tabla_estado_registro_origen_id, #tabla_estado_registro_destino_id').append($('<option>', {
                        value: estado.tabla_estado_registro_id,
                        text: estado.estado_registro
                    }));
                });
            } else {
                $('#tabla_estado_registro_origen_id, #tabla_estado_registro_destino_id').empty().append('<option value="">No hay estados para esta tabla</option>');
            }
        }, 'json');
    }
