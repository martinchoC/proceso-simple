                                            ...
                                            <thead>
                                                ...
                                                <tr class="filters">
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Razón Social" /></th>
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Tipo Doc" /></th>
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Nro.Doc" /></th>
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Domicilio" /></th>
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Localidad" /></th>
                                                    <th><input type="text" class="form-control form-control-sm"
                                                            placeholder="Filtrar Estado" /></th>
                            ...
                            <form id="formempresa">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="documento_tipo_id"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" step="any" class="form-control" id="base_conf"
                                            name="base_conf" />
                                    </div>

                                    <div class="col-md-6">
                                        <label>Estado Registro ID</label>
                                        <input type="number" class="form-control" id="tabla_estado_registro_id"
                                            name="tabla_estado_registro_id" />
                                    </div>
                                </div>
                            </form>
                        </div>
