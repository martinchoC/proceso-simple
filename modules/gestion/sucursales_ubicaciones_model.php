...
function ejecutarTransicionEstado($conexion, $sucursal_ubicacion_id, $accion_js, $empresa_idx, $pagina_id) {
    ...
    if (!$ubicacion) return ['success' => false, 'error' => 'Acceso denegado o registro no encontrado'];
...
function agregarSucursalUbicacion($conexion, $data) {
    ...
    mysqli_stmt_bind_param($stmt, "iissssi", $empresa_idx, $sucursal_id, $seccion, $estanteria, 
                           $estante, $descripcion, $estado_registro_id);
    $success = mysqli_stmt_execute($stmt);
