                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">  
                                    ...
                                    <div class="card-body">
                                        <!-- DataTable -->
                                        <table id="tablaComprobantesFiscales" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <form id="formComprobanteFiscal" class="needs-validation" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="comprobante_fiscal" name="comprobante_fiscal" 
