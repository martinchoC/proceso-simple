        ...
        <div class="container-fluid">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="estado_registro_id_tipo" name="estado_registro_id" value="1" checked>
                                            <label class="form-check-label" for="estado_registro_id_tipo">Tipo activo</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="modal-body">
                            <form id="formEstado">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="estado_registro_id_estado" name="estado_registro_id" value="1" checked>
                                            <label class="form-check-label" for="estado_registro_id_estado">Estado activo</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            $(document).ready(function(){
                ...
                $('#btnNuevoTipo').click(function(){
                    $('#formTipo')[0].reset();
                    $('#tabla_tipo_id').val('');
                    $('#estado_registro_id_tipo').prop('checked', true);
                ...
                $('#tablaTipos tbody').on('click', '.btnEditarTipo', function(){
                    ...
                    $.get('tablas_tipos_ajax.php', {accion: 'obtener_tipo', tabla_tipo_id: data.tabla_tipo_id}, function(res){
                        if(res){
                            ...
                            $('#estado_registro_id_tipo').prop('checked', res.estado_registro_id == 1);
                ...
                $('#btnNuevoEstado').click(function(){
                    ...
                    $('#valor').val(0);
                    $('#estado_registro_id_estado').prop('checked', true);
                ...
                $(document).on('click', '.btnEditarEstado', function(){
                    ...
                    $.get('tablas_tipos_ajax.php', {accion: 'obtener_estado', tabla_tipo_estado_id: data.tabla_tipo_estado_id}, function(res){
                        if(res){
                            ...
                            $('#valor').val(res.valor);
                            $('#estado_registro_id_estado').prop('checked', res.estado_registro_id == 1);
                ...
                $('#btnGuardarTipo').click(function(){
                    ...
                    var formData = {
                        ...
                        estado_registro_id: $('#estado_registro_id_tipo').is(':checked') ? 1 : 0
                    };
                ...
                $('#btnGuardarEstado').click(function(){
                    ...
                    var formData = {
                        ...
                        valor: $('#valor').val(),
                        estado_registro_id: $('#estado_registro_id_estado').is(':checked') ? 1 : 0
                    };
