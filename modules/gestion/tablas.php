        ...
        <div class="container-fluid">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="tabla_tabla_estado_registro_id" name="tabla_tabla_estado_registro_id" value="1" checked>
                                            <label class="form-check-label" for="tabla_tabla_estado_registro_id">Tabla activa</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            $(document).ready(function(){
                ...
                var tabla = $('#tablaTablas').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function(data){
                                var estadoTexto = data.tabla_tabla_estado_registro_id == 1 ? 
                                ...
                                var botonEstado = 
                                    `<div class="form-check form-switch d-inline-block">
                                        <input class="form-check-input toggle-estado"
                                            ...
                                            ${data.tabla_tabla_estado_registro_id == 1 ? 'checked' : ''}>
                                    </div>`;
                        ...
                        },
                        {
                            ...
                            className: "text-center",
                            render: function(data){
                                var botonEditar = data.tabla_tabla_estado_registro_id == 1 ? 
                    ...
                    createdRow: function(row, data, dataIndex) {
                        ...
                        if (data.tabla_tabla_estado_registro_id != 1) {
                ...
                $('#btnNuevo').click(function(){
                    $('#formTabla')[0].reset();
                    $('#tabla_id').val('');
                    $('#tabla_tabla_estado_registro_id').prop('checked', true);
                ...
                $('#tablaTablas tbody').on('click', '.btnEditar', function(){
                    ...
                    $.get('tablas_ajax.php', {accion: 'obtener', tabla_id: data.tabla_id}, function(res){
                        if(res){
                            ...
                            $('#tabla_tabla_estado_registro_id').prop('checked', res.tabla_tabla_estado_registro_id == 1);
                ...
                $('#btnGuardar').click(function(){
                    ...
                    var formData = {
                        ...
                        tabla_tabla_estado_registro_id: $('#tabla_tabla_estado_registro_id').is(':checked') ? 1 : 0
                    };
