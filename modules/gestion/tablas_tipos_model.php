...
function obtenerTablasTipos($conexion) {
    $sql = "SELECT tt.*, COUNT(tte.tabla_tipo_estado_id) as cantidad_estados
            ...
            LEFT JOIN conf__tablas_tipos_estados tte ON tt.tabla_tipo_id = tte.tabla_tipo_id AND tte.estado_registro_id = 1
...
function agregarTablaTipo($conexion, $data) {
    ...
    $sql = "INSERT INTO conf__tablas_tipos (tabla_tipo, estado_registro_id) 
            VALUES ('$tabla_tipo', $estado_registro_id)";
...
function cambiarEstadoTablaTipo($conexion, $id, $nuevo_estado) {
    ...
    $sql = "UPDATE conf__tablas_tipos SET estado_registro_id = $nuevo_estado WHERE tabla_tipo_id = $id";
    return mysqli_query($conexion, $sql);
}
...
function agregarTablaTipoEstado($conexion, $data) {
    ...
    $sql = "INSERT INTO conf__tablas_tipos_estados 
            (tabla_tipo_id, tabla_tipo_estado, tabla_tipo_estado_descripcion, valor, estado_registro_id) 
            VALUES 
            ($tabla_tipo_id, '$tabla_tipo_estado', '$tabla_tipo_estado_descripcion', $valor, $estado_registro_id)";
...
function cambiarEstadoTablaTipoEstado($conexion, $id, $nuevo_estado) {
    ...
    $sql = "UPDATE conf__tablas_tipos_estados SET estado_registro_id = $nuevo_estado WHERE tabla_tipo_estado_id = $id";
    return mysqli_query($conexion, $sql);
}
?>