...
<style>
    #tablaProveedorPrecios, #tablaProveedorPrecios th, #tablaProveedorPrecios td {
        font-size: 0.82rem;
    }
</style>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-2 text-end">
                                                <button type="button" class="btn btn-sm btn-outline-warning" id="btnActualizarCostosMasivo" disabled title="Actualizar el costo de TODOS los productos de este proveedor">
                                                    <i class="fas fa-coins me-1"></i>Actualizar Costos
                                                </button>
                                            </div>
                                            <div class="col-md-2 text-end">
                                        ...
                                        <div class="row align-items-center mt-2">
                                            <div class="col-md-4">
                                                <div class="dataTables_length" id="tablaProveedorPrecios_length"></div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="dataTables_filter" id="tablaProveedorPrecios_filter"></div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-3">
                            <input type="hidden" id="producto_proveedor_id">
                            <input type="hidden" id="producto_proveedor_precio_id">

                            <div id="bloqueBuscarProducto">
                                <label>Buscar producto del proveedor</label>
