                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item">
                            <?php echo htmlspecialchars($contexto['modulo_nombre'] ?? 'Gestión'); ?></li>
                        <li class="breadcrumb-item active" aria-current="page">
                            <?php echo htmlspecialchars($contexto['pagina_nombre'] ?? 'Marcas'); ?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
                ...
                <div class="card-body bg-light py-2">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <strong><?php echo htmlspecialchars($contexto['modulo_nombre'] ?? 'N/D'); ?> (ID:
                                <?php echo $modudo_idx; ?>)</strong>
                        </div>
                        <div class="col-md-3">
                            <small class="text-muted"><i class="fas fa-file-alt me-1"></i>Página:</small>
                            <strong><?php echo htmlspecialchars($contexto['pagina_nombre'] ?? 'N/D'); ?> (ID:
                                <?php echo $pagina_idx; ?>)</strong>
            ...
            <?php if (!$config_pagina['configurada']): ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <strong>Atención:</strong> Esta página no tiene funciones configuradas en
                    <code>conf__paginas_funciones</code>.
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="float-end">
                                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                                id="btnRecargar" title="Recargar datos">
