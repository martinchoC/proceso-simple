    ...
    try {
        if ($accion == 'editar' && $modulo_id > 0) {
            ...
            $stmt->bind_param("sssssiii", 
                $datos['modulo'], $datos['base_datos'], $datos['modulo_url'],
                $datos['email_envio_modulo'], $datos['layout_nombre'],
                $datos['depende_id'], $datos['estado_registro_id'], $modulo_id);
        } else {
            ...
            $stmt->bind_param("sssssii", 
                $datos['modulo'], $datos['base_datos'], $datos['modulo_url'],
                $datos['email_envio_modulo'], $datos['layout_nombre'],
                $datos['depende_id'], $datos['estado_registro_id']);
        }
